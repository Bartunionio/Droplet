    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "John", "Doe", "90060184361" },
                    { 2, "Jane", "Doe", "94110926169" },
                    { 3, "Alice", "Smith", "99061937114" },
                    { 4, "Bob", "Johnson", "56051657197" },
                    { 5, "Charlie", "Brown", "84101422862" },
                    { 6, "Dave", "Wilson", "96110262292" },
                    { 7, "Eve", "Davis", "62030165469" },
                    { 8, "Frank", "Miller", "72061521868" }
                });

            migrationBuilder.InsertData(
                table: "Donors",
                columns: new[] { "Id", "BloodType", "FirstName", "LastName", "PESEL" },
                values: new object[,]
                {
                    { 1, 3, "Frank", "Miller", "78011762657" },
                    { 2, 5, "Grace", "Adams", "58031151389" },
                    { 3, 7, "Hank", "Baker", "63082969285" },
                    { 4, 2, "Ivy", "Clark", "71021617898" },
                    { 5, 1, "Jack", "Evans", "61020226252" },
                    { 6, 0, "Kate", "Fisher", "60042994741" },
                    { 7, 6, "Leo", "Garcia", "64082237664" },
                    { 8, 4, "Mia", "Harris", "70070919982" },
                    { 9, 2, "Nina", "Ivanov", "83100453712" },
                    { 10, 0, "Oscar", "Jones", "70011425996" },
                    { 11, 5, "Paul", "Kim", "90071459573" },
                    { 12, 7, "Quinn", "Lopez", "80082622961" },
                    { 13, 1, "Rose", "Martinez", "96110619575" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 7, "Sam", "Nelson", "73040165268" },
                    { 2, 2, "Tina", "O'Neill", "74071689484" },
                    { 3, 1, "Uma", "Perez", "90102796295" },
                    { 4, 0, "Victor", "Quinn", "65110111691" },
                    { 5, 6, "Wendy", "Reed", "71102928565" },
                    { 6, 4, "Xander", "Sanchez", "93100227217" },
                    { 7, 2, "Yara", "Thomas", "97120413337" }
                });
